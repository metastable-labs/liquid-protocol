...
import {CoinbaseSmartWallet} from "@coinbase/smart-wallet/src/CoinbaseSmartWallet.sol";
import {LibClone} from "solady/utils/LibClone.sol";

/// @title Liquid Smart Wallet Factory
///
/// @notice Liquid factory, based on Coinbase's ERC4337Factory.
///
/// @author Coinbase (https://github.com/coinbase/smart-wallet)
/// @author Solady (https://github.com/vectorized/solady/blob/main/src/accounts/ERC4337Factory.sol)
contract LiquidSmartWalletFactory {
    ...
    ///
    /// @param implementation_ The address of the CoinbaseSmartWallet implementation which new Liquid accounts will proxy to.
